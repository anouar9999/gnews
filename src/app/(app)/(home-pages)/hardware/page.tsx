...
const CategoryPostCard = ({ post }: { post: any }) => {
  return (
    <Link
      ...
      className="group relative overflow-hidden bg-white shadow-md transition-all duration-500 hover:shadow-xl hover:shadow-blue-600/10"
    >
      {/* Image */}
      <div className="relative h-64 overflow-hidden bg-neutral-100">
        ...
        {post.category && (
          <div className="absolute top-4 left-4">
            <span
              style={Font.style}
              className="inline-flex items-center gap-1.5 bg-blue-600 px-3 py-1.5 text-xs font-bold tracking-wider text-white uppercase shadow-lg"
            >
      ...
      <div className="p-6">
        ...
        <h3
          style={myFont.style}
          className="mb-3 line-clamp-2 text-xl leading-tight font-black text-neutral-900 transition-colors duration-300 group-hover:text-blue-600"
        >
          {post.title}
        </h3>
        ...
        <div className="flex items-center justify-between border-t border-neutral-100 pt-4">
          ...
          {/* Read more arrow */}
          <div className="flex items-center gap-2 text-sm font-bold text-blue-600 transition-transform duration-300 group-hover:translate-x-2">
            <span>Read</span>
