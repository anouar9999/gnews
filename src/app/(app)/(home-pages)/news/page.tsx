        ...
        <div className="container">
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex items-center gap-6">
              <div>
                <div className="text-2xl font-black text-indigo-600">{newsPosts.length}</div>
                <div className="text-xs font-medium text-neutral-500 uppercase">Articles</div>
              </div>
              <div className="h-10 w-[1px] bg-neutral-200" />
              <div>
                <div className="text-2xl font-black text-indigo-600">Breaking</div>
                <div className="text-xs font-medium text-neutral-500 uppercase">News</div>
              </div>
            </div>
          </div>
        </div>
...
const CategoryPostCard = ({ post }: { post: any }) => {
  return (
    <Link
      ...
      className="group relative overflow-hidden bg-white shadow-md transition-all duration-500 hover:shadow-xl hover:shadow-indigo-600/10"
    >
      {/* Image */}
      <div className="relative h-64 overflow-hidden bg-neutral-100">
        ...
        {post.category && (
          <div className="absolute top-4 left-4">
            <span
              style={Font.style}
              className="inline-flex items-center gap-1.5 bg-indigo-600 px-3 py-1.5 text-xs font-bold tracking-wider text-white uppercase shadow-lg"
            >
      ...
      <div className="p-6">
        ...
        <h3
          style={myFont.style}
          className="mb-3 line-clamp-2 text-xl leading-tight font-black text-neutral-900 transition-colors duration-300 group-hover:text-indigo-600"
        >
          {post.title}
        </h3>
        ...
        <div className="flex items-center justify-between border-t border-neutral-100 pt-4">
          ...
          {/* Read more arrow */}
          <div className="flex items-center gap-2 text-sm font-bold text-indigo-600 transition-transform duration-300 group-hover:translate-x-2">
            <span>Read</span>
      ...
      {/* Border animation */}
      <div className="absolute inset-0 border-2 border-transparent transition-colors duration-300 group-hover:border-indigo-600" />
    </Link>
  )
}
